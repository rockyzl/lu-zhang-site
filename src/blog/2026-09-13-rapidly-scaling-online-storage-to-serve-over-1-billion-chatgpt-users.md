---
title: "Daily signal: Rapidly scaling online storage to serve over 1 billion ChatGPT users"
...
**Daily signal: Rapidly scaling online storage to serve over 1 billion ChatGPT users**
...
The signal selected today is [Rapidly scaling online storage to serve over 1 billion ChatGPT users](https://openai.com/index/scaling-storage-one-billion-users-part-one) from OpenAI News.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Rapidly scaling online storage to serve over 1 billion ChatGPT users</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Rapidly scaling online storage to serve over 1 billion ChatGPT users</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
