---
title: "Daily signal: Orchard: An open framework for scalable agentic AI"
...
**Daily signal: Orchard: An open framework for scalable agentic AI**
...
The signal selected today is [Orchard: An open framework for scalable agentic AI](https://www.microsoft.com/en-us/research/blog/orchard-an-open-framework-for-scalable-agentic-ai/) from Microsoft Research Blog.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Orchard: An open framework for scalable agentic AI</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Orchard: An open framework for scalable agentic AI</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
...
Source: [Orchard: An open framework for scalable agentic AI](https://www.microsoft.com/en-us/research/blog/orchard-an-open-framework-for-scalable-agentic-ai/)
