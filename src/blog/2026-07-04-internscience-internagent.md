---
title: "Daily signal: InternScience/InternAgent"
...
**Daily signal: InternScience/InternAgent**
...
The signal selected today is [InternScience/InternAgent](https://github.com/InternScience/InternAgent) from GitHub repository search (1,352 stars at scan time).
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">InternScience/InternAgent</h3>
      <p class="signal-card__summary">
        Automated candidate selected from GitHub repository search (1,352 stars at scan time). Treat this as a
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>InternScience/InternAgent</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
