---
title: "Daily signal: charlieviettq/awesome-agent-skill"
...
**Daily signal: charlieviettq/awesome-agent-skill**
...
The signal selected today is [charlieviettq/awesome-agent-skill](https://github.com/charlieviettq/awesome-agent-skill) from GitHub repository search (25 stars at scan time).
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">charlieviettq/awesome-agent-skill</h3>
      <p class="signal-card__summary">
        Automated candidate selected from GitHub repository search (25 stars at scan time). Treat this as a
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>charlieviettq/awesome-agent-skill</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
...
Source: [charlieviettq/awesome-agent-skill](https://github.com/charlieviettq/awesome-agent-skill)
