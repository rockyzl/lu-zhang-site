---
title: "Daily signal: ekstasisSH/wenshu"
...
**Daily signal: ekstasisSH/wenshu**
...
The signal selected today is [ekstasisSH/wenshu](https://github.com/ekstasisSH/wenshu) from GitHub repository search (12 stars at scan time).
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">ekstasisSH/wenshu</h3>
      <p class="signal-card__summary">
        Automated candidate selected from GitHub repository search (12 stars at scan time). Treat this as a
...
Source: [ekstasisSH/wenshu](https://github.com/ekstasisSH/wenshu)
