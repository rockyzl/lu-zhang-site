---
title: "Daily signal: google-deepmind/science-skills"
...
**Daily signal: google-deepmind/science-skills**
...
The signal selected today is [google-deepmind/science-skills](https://github.com/google-deepmind/science-skills) from GitHub repository search (2,892 stars at scan time).
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">google-deepmind/science-skills</h3>
      <p class="signal-card__summary">
        Automated candidate selected from GitHub repository search (2,892 stars at scan time). Treat this as a
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>google-deepmind/science-skills</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
