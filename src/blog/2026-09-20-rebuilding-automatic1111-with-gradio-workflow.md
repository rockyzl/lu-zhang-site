---
title: "Daily signal: Rebuilding AUTOMATIC1111 with Gradio Workflow"
...
**Daily signal: Rebuilding AUTOMATIC1111 with Gradio Workflow**
...
The signal selected today is [Rebuilding AUTOMATIC1111 with Gradio Workflow](https://huggingface.co/blog/gradio-workflow-1111) from Hugging Face Blog.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Rebuilding AUTOMATIC1111 with Gradio Workflow</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Rebuilding AUTOMATIC1111 with Gradio Workflow</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
