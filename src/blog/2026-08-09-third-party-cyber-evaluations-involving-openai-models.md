---
title: "Daily signal: Third-party cyber evaluations involving OpenAI models"
...
**Daily signal: Third-party cyber evaluations involving OpenAI models**
...
The signal selected today is [Third-party cyber evaluations involving OpenAI models](https://openai.com/index/third-party-cyber-evaluations-involving-openai-models) from OpenAI News.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Third-party cyber evaluations involving OpenAI models</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Third-party cyber evaluations involving OpenAI models</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
