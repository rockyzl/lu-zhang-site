---
title: "Daily signal: TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery"
...
**Daily signal: TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery**
...
The signal selected today is [TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery](https://arxiv.org/abs/2608.23631) from arXiv cs.AI.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
...
Source: [TRACE: Transition-Aware Residual Control for Multi-Objective Materials Discovery](https://arxiv.org/abs/2608.23631)
