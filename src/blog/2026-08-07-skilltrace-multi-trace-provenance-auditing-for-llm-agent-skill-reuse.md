---
title: "Daily signal: SkillTrace: Multi-Trace Provenance Auditing for LLM-Agent Skill Reuse"
...
**Daily signal: SkillTrace: Multi-Trace Provenance Auditing for LLM-Agent Skill Reuse**
...
The signal selected today is [SkillTrace: Multi-Trace Provenance Auditing for LLM-Agent Skill Reuse](https://arxiv.org/abs/2608.05204) from arXiv cs.AI.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">SkillTrace: Multi-Trace Provenance Auditing for LLM-Agent Skill Reuse</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>SkillTrace: Multi-Trace Provenance Auditing for LLM-Agent Skill Reuse</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
...
Source: [SkillTrace: Multi-Trace Provenance Auditing for LLM-Agent Skill Reuse](https://arxiv.org/abs/2608.05204)
