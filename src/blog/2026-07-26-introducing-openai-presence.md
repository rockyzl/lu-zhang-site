---
title: "Daily signal: Introducing OpenAI Presence"
...
**Daily signal: Introducing OpenAI Presence**
...
The signal selected today is [Introducing OpenAI Presence](https://openai.com/index/introducing-openai-presence) from OpenAI News.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Introducing OpenAI Presence</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Introducing OpenAI Presence</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
