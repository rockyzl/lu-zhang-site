---
title: "Daily signal: SakanaAI/AI-Scientist-v2"
...
**Daily signal: SakanaAI/AI-Scientist-v2**
...
The signal selected today is [SakanaAI/AI-Scientist-v2](https://github.com/SakanaAI/AI-Scientist-v2) from GitHub repository search (6,712 stars at scan time).
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">SakanaAI/AI-Scientist-v2</h3>
      <p class="signal-card__summary">
        Automated candidate selected from GitHub repository search (6,712 stars at scan time). Treat this as a
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>SakanaAI/AI-Scientist-v2</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
