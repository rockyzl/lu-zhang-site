---
title: "Daily signal: How NVIDIA scales expertise with ChatGPT Work"
...
**Daily signal: How NVIDIA scales expertise with ChatGPT Work**
...
The signal selected today is [How NVIDIA scales expertise with ChatGPT Work](https://openai.com/index/nvidia/chatgpt-work) from OpenAI News.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">How NVIDIA scales expertise with ChatGPT Work</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>How NVIDIA scales expertise with ChatGPT Work</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
