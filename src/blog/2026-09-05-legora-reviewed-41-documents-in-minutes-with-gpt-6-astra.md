---
title: "Daily signal: Legora reviewed 41 documents in minutes with GPT-6 Astra"
...
**Daily signal: Legora reviewed 41 documents in minutes with GPT-6 Astra**
...
The signal selected today is [Legora reviewed 41 documents in minutes with GPT-6 Astra](https://openai.com/index/legora-financial-statement-review-with-astra) from OpenAI News.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Legora reviewed 41 documents in minutes with GPT-6 Astra</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Legora reviewed 41 documents in minutes with GPT-6 Astra</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
