---
title: "Daily signal: Introducing Astra for Law"
...
**Daily signal: Introducing Astra for Law**
...
The signal selected today is [Introducing Astra for Law](https://openai.com/index/astra-for-law) from OpenAI News.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Introducing Astra for Law</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Introducing Astra for Law</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
