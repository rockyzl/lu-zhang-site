---
title: "Daily signal: Beyond Right and Wrong: Evaluating Second-order Social Reasoning in Large Language Models"
...
**Daily signal: Beyond Right and Wrong: Evaluating Second-order Social Reasoning in Large Language Models**
...
The signal selected today is [Beyond Right and Wrong: Evaluating Second-order Social Reasoning in Large Language Models](https://arxiv.org/abs/2609.05437) from arXiv cs.AI.
...
<section class="signal-card signal-card--compact signal-card--visual" aria-label="SciencesLoop Signal Card">
  <div class="signal-card__top">
    <div>
      ...
      <h3 class="signal-card__title">Beyond Right and Wrong: Evaluating Second-order Social Reasoning in Large Language Models</h3>
  ...
  <dl class="signal-card__details">
    <div class="signal-card__detail">
      <dt>Signal</dt>
      <dd>Beyond Right and Wrong: Evaluating Second-order Social Reasoning in Large Language Models</dd>
    </div>
    <div class="signal-card__detail">
      <dt>Run status</dt>
...
Source: [Beyond Right and Wrong: Evaluating Second-order Social Reasoning in Large Language Models](https://arxiv.org/abs/2609.05437)
