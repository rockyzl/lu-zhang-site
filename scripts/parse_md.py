...
# NOTE: publications.json is now generated by scripts/fetch_openalex.py
# using affiliation-based verification (preferred). The legacy code below
# still runs but its output for publications is overwritten. Keeping the
# old logic for patents.json + conferences.json which the new script
# doesn't fetch.
import re as _re
